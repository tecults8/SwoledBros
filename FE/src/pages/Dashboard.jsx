                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <h3 style={{ fontSize: '22px', fontWeight: '600', margin: '0 0 10px 0' }}>Progress checker</h3>
                        ...
                        <div style={{
                            ...
                            <h3 style={{ fontSize: '22px', fontWeight: '600', margin: '0 0 10px 0' }}>Step counts</h3>
                            <p style={{ fontSize: '72px', fontWeight: 'bold', margin: '0', lineHeight: '1' }}>15</p>
